'''
This file is a first draft of printing the dataset information, f.ex word count, article length etc. 
It needs to be improved for a full infromation overview
'''
